...
$("nav").on("click", "a", function (event) {
  ...
  top = $(id).offset().top - 70; // анимируем переход к блоку, время: 800 мс
...
})(jQuery); //Анимация элементов насайте/////////////////////////////////////////////////////////////////////////////////////////////////////
...
da.init(); // Определение поддержки браузером формата webp для использования webp в свойстве background-image в scss////////////////////////
